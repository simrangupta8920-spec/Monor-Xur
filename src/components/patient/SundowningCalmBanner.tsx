      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          ...
          <div>
            <div className="flex items-center gap-2 flex-wrap">
              <span className="px-2 py-0.5 rounded-full bg-[#E8B25C]/20 text-[#8C651E] text-[10px] font-black uppercase tracking-wider">
                {isManualOverride 
                  ? tx('Twilight Calming • Caregiver Preview', 'गोधूलि शांति • पूर्वावलोकन', 'গধূলিৰ প্ৰশান্তি • যত্নকৰ্তাৰ পূৰ্বদৃশ্য') 
                  : tx('Sundowning Support (4:30 – 7:30 PM)', 'गोधूलि शांति समय (4:30 – 7:30 PM)', 'গধূলিৰ প্ৰশান্তি সময় (৪:৩০ – ৭:৩০ বজা)')}
              </span>
              <span className="text-[11px] font-bold text-[#8C651E] flex items-center gap-1">
                <Volume2 className="w-3 h-3 text-[#8C651E]" />
                {tx('Soft Chimes & Warm Lighting Active', 'धीमी मधुर ध्वनियां व शांत प्रकाश', 'মৃদু সুৰ আৰু শান্ত পোহৰ সক্ৰিয়')}
              </span>
            </div>
            <h4 className="text-sm sm:text-base font-black text-[#2D3A2F] mt-0.5 leading-snug">
              {tx('Restful Evening Time', 'आरामदायक संध्या काल', 'আৰামদায়ক গধূলিৰ ক্ষণ')}
            </h4>
            <p className="text-xs text-[#5A6E5D] max-w-xl">
              {tx(
                ...
                'গধূলিৰ ক্লান্তি আৰু অস্বস্তি দূৰ কৰিবলৈ পৰ্দাৰ উজ্জ্বলতা কোমল কৰা হৈছে আৰু মৃদু ধ্বনি সংলগ্ন কৰা হৈছে। আহক একেলগে জিৰণি লওঁ।'
              )}
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 self-end sm:self-center shrink-0 flex-wrap">
          ...
          >
            ...
            <span>
              {isPlayingRaga
                ? tx('Stop Evening Raga', 'राग यमन रोकें', 'সন্ধ্যা ৰাগ যমন বন্ধ কৰক')
                : tx('Play Evening Raga', 'संध्या राग यमन सुनें', 'সন্ধ্যা ৰাগ যমন শুনক')}
            </span>
          </button>
          ...
          {onOpenBreathing && (
            ...
            >
              ...
              <span>{tx('4-7-8 Breathing', '4-7-8 श्वास अभ्यास', '৪-৭-৮ উশাহ-নিশাহৰ অভ্যাস')}</span>
            </button>
          )}
